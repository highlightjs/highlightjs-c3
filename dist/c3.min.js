...
}],relevance:0},n={className:"string",variants:[{begin:'(x|b64)?"',end:'"',
illegal:"\\n",contains:[e.BACKSLASH_ESCAPE]},{
begin:"(u8?|U|L)?'(\\\\(x[0-9A-Fa-f]{2}|u[0-9A-Fa-f]{4,8}|[0-7]{3}|\\S)|.)",
end:"'",illegal:"."},e.END_SAME_AS_BEGIN({
begin:/(?:u8?|U|L)?([^()\\ ]{0,16})\(/,end:/\)([^()\\ ]{0,16})"/})]},r={
...
},s=e.regex,i="[a-z_]\\w*::",o="("+DECLTYPE_AUTO_RE+"|"+s.optional(i)+"[a-zA-Z_]\\w*"+s.optional("<[^<>]+>")+")",c={
className:"title",begin:s.optional(i)+e.IDENT_RE,relevance:0
},l=s.optional(i)+e.IDENT_RE+"\\s*\\(",d={
begin:"\\s*fn\\s*("+o+"[!\\*&\\s]+)+"+l,returnBegin:!0,end:/[{;=]/,
excludeEnd:!0,keywords:r,illegal:/[^\w\s\*&:<>.]/,contains:[{
begin:DECLTYPE_AUTO_RE,keywords:r,relevance:0},{begin:l,returnBegin:!0,
contains:[e.inherit(c,{className:"title.function"})],relevance:0},{
className:"params",begin:/\(/,end:/\)/,keywords:r,relevance:0,
contains:[e.C_LINE_COMMENT_MODE,$,n,a,t,{begin:/\(/,end:/\)/,keywords:r,
relevance:0,contains:["self",e.C_LINE_COMMENT_MODE,$,n,a,t]}]
},t,e.C_LINE_COMMENT_MODE,$]};return{name:"C3",keywords:r,
contains:[e.C_LINE_COMMENT_MODE,$,a,n,t,{className:"keyword",

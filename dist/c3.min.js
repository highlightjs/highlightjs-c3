...
keyword:"alias as assert asm bitstruct break case catch const continue define default defer do else enum extern false fault for foreach foreach_r fn generic tlocal if import macro module nextcase null private return static struct switch true try union var while typedef distinct initialize finalize inline"
...
},i=e.regex,s="[a-zA-Z_]\\w*::",o="(decltype\\(auto\\)|"+i.optional(s)+"[a-zA-Z_]\\w*"+i.optional("<[^<>]+>")+")",l={
className:"title",begin:i.optional(s)+e.IDENT_RE,relevance:0
},c=i.optional(s)+e.IDENT_RE+"\\s*\\(",d={
begin:"\\s*fn\\s*("+o+"[!\\*&\\s]+)+"+c,returnBegin:!0,end:/[{;=]/,
excludeEnd:!0,keywords:t,illegal:/[^\w\s\*&:<>.]/,contains:[{
begin:"decltype\\(auto\\)",keywords:t,relevance:0},{begin:c,returnBegin:!0,
